...
func main() {
	...
	app.Get("/", func(c *fiber.Ctx) error {
		return c.JSON(fiber.Map{
			...
			"carnet":     carnet,
			"endpoints": []string{
				"/api3/202200214/llamar-api1",
				"/api3/202200214/llamar-api2",
			},
		})
	})
	...
	// Endpoint para llamar a API1 (VM1)
	...
	// Endpoint para llamar a API2 (VM1)
	...
	fmt.Printf("🚀 API3 iniciada en puerto 8082\n")
	...
	fmt.Printf("   • GET %sllamar-api2 - Llamar a API2\n", endPointGeneric)
